...
- **Naming:** in Dec 2025 AWS renamed the original Security Hub to **Security Hub CSPM** and
  launched a new, OCSF-based "AWS Security Hub". The NIST 800-53 standard, its control IDs,
  and the `aws_securityhub_*` Terraform resources belong to Security Hub CSPM.
